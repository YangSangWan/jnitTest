...
public class BookApiController { //컴포지션 = has 관계
    ...
    public ResponseEntity<?> getBookList(){
        ...
        return new ResponseEntity<>(CMRespDto.builder().code(1).msg("글 목록보기 성공").body(bookListRespDto).build(), HttpStatus.OK); //201=insert
    }
    ...
    public ResponseEntity<?> deleteBook(@PathVariable Long id){
        ...
        return new ResponseEntity<>(CMRespDto.builder().code(1).msg("글 한건보기 성공").body(null).build(), HttpStatus.OK); 
    }
